  ...
  return {
    ...
    [ifaceV3.getSighash('exactInputSingle')]: (txn, network, opts = {}) => {
      ...
      return !opts.extended 
        ...
        : toExtended('Swap', 'for at least', token(humanizerInfo, params.tokenIn, params.amountIn, true), token(humanizerInfo, params.tokenOut, params.amountOutMinimum, true), recipientText(humanizerInfo, params.recipient, txn.from, true), deadlineText(params.deadline, opts.mined))
    },
    [ifaceV3.getSighash('exactInput')]: (txn, network, opts = {}) => {
      ...
      return !opts.extended 
        ...
        : toExtended('Swap', 'for at least', token(humanizerInfo, path[0], params.amountIn, true), token(humanizerInfo, path[path.length - 1], params.amountOutMinimum, true), recipientText(humanizerInfo, params.recipient, txn.from, true), deadlineText(params.deadline, opts.mined))
    },
    [ifaceV3.getSighash('exactOutputSingle')]: (txn, network, opts = {}) => {
      ...
      return !opts.extended 
        ...
        : toExtended('Swap up to', 'for', token(humanizerInfo, params.tokenIn, params.amountInMaximum, true), token(humanizerInfo, params.tokenOut, params.amountOut, true), recipientText(humanizerInfo, params.recipient, txn.from, true), deadlineText(params.deadline, opts.mined))
    },
    [ifaceV3.getSighash('exactOutput')]: (txn, network, opts = {}) => {
      ...
      return !opts.extended 
        ...
        : toExtended('Swap up to', 'for', token(humanizerInfo, path[path.length - 1], params.amountInMaximum, true), token(humanizerInfo, path[0], params.amountOut, true), recipientText(humanizerInfo, params.recipient, txn.from, true), deadlineText(params.deadline, opts.mined))
    },
  ...
  return {
    ...
    [ifaceV32.getSighash('unwrapWETH9(uint256)')]: (txn, network, opts = {}) => {
      ...
      return !opts.extended
        ...
        : toExtendedUnwrap('Unwrap at least', network, amountMin, true)
    },
