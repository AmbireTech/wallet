        ...
        methods:[
            {
                ...
                summary: ({network, txn, inputs, contract}) => {
                    ...
                    //process.exit();
                    const SF = new SummaryFormatter(network, contract.manager).mainAction('multicall')
            ...
            },
            {
                ...
                summary: ({network, txn, inputs, contract}) => {
                    const SF = new SummaryFormatter(network, contract.manager).mainAction('self_permit')
                    return SF.actions([
                        SF.text('Self Permit')
                          .action()
                    ])
