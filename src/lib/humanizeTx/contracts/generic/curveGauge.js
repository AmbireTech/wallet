...
module.exports = {
  ...
  interface: {
    ...
    abi: [{
      ...
      'inputs': [{'type': 'address', 'name': 'user', 'indexed': false}, {
        'type': 'uint256',
      ...
      'outputs': [],
      'inputs': [{'type': 'address', 'name': 'lp_addr'}, {'type': 'address', 'name': '_minter'}],
      ...
      'outputs': [],
      'inputs': [{'type': 'address', 'name': 'addr'}, {'type': 'bool', 'name': 'can_deposit'}],
      'stateMutability': 'nonpayable',
      'type': 'function',
      'gas': 35766
    },
      ...
      //{'name':'deposit','outputs':[],'inputs':[{'type':'uint256','name':'_value'},{'type':'address','name':'addr'}],'stateMutability':'nonpayable','type':'function'},
      {
        ...
        'outputs': [{'type': 'bool', 'name': ''}],
        'inputs': [{'type': 'address', 'name': 'arg0'}, {'type': 'address', 'name': 'arg1'}],
        'stateMutability': 'view',
        'type': 'function',
        'gas': 1969
      }, {
