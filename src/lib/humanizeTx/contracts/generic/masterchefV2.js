  ...
  interface: {
    ...
    abi: [{
      ...
      'inputs': [{'internalType': 'contract IERC20', 'name': 'token', 'type': 'address'}, {
        ...
        'name': 's',
        'type': 'bytes32'
      }], 'name': 'permitToken', 'outputs': [], 'stateMutability': 'nonpayable', 'type': 'function'
    }, {
      'inputs': [{'internalType': 'uint256', 'name': '', 'type': 'uint256'}],
      'name': 'poolInfo',
      'outputs': [{'internalType': 'uint128', 'name': 'accSushiPerShare', 'type': 'uint128'}, {
        'internalType': 'uint64',
        'name': 'lastRewardBlock',
        'type': 'uint64'
      ...
      'outputs': [{
        'components': [{
          ...
          'name': 'allocPoint',
          'type': 'uint64'
        }], 'internalType': 'struct MasterChefV2.PoolInfo', 'name': 'pool', 'type': 'tuple'
      }],
      'stateMutability': 'nonpayable',
      'type': 'function'
    }, {
