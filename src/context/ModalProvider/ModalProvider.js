    ...
    >
      {modal ? (
        <div className={styles.wrapper}>
          <div className={styles.backdrop} onClick={modal.opts.disableClose ? null : onHideModal} />
          {modal.element}
        </div>
      ) : null}
      {dynamicModal ? (
        <div className={styles.wrapper}>
          <div
            ...
            onClick={dynamicModal.opts && dynamicModal.opts.disableClose ? null : onHideModal}
          />
