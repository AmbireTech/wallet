import './MoonPayDepositProviderModal.scss'
...
const MoonPayDepositProviderModal = ({ relayerURL, walletAddress, selectedNetwork, portfolio }) => {
    const { hideModal } = useModals()
    const { addToast } = useToasts()
    const guardarian = useMoonPay({relayerURL, selectedNetwork, initMode: 'buy', tokens: portfolio.tokens, walletAddress, addToast })
    ...
    return (
        <Modal id="guardarian-modal" title="MoonPay" buttons={buttons}>
...
export default MoonPayDepositProviderModal