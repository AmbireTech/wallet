        ...
        <div className={'wallet-rewards-status-holder'}>
          <div className={'wallet-rewards-status'}>
            ...
            <div className={`rewards-bar ${isEligible ? 'active' : 'inactive'}`}>
              <div className={'rewards-bar-progress'}
              ...
              canClaimWallet
                ? (<div className='actions'>
                  <ToolTip label={
                    ...
                    <Button className='claim-rewards-with-burn' small clear onClick={openUnbondModal}
                  ...
                  <ToolTip label={
                    ...
                    <Button className='claim-rewards-x-wallet' small clear onClick={claimEarlyRewards}
