...
const UnsupportedDAppsModal = ({ connections, disconnect, advancedModeList, onContinue }) => {
  ...
  return (
    ...
    >
      ...
      <div className={styles.message}>
        For more information on why these dApps do not support Ambire, please read{' '}
        <a
          href="https://help.ambire.com/hc/en-us/articles/4415496135698-Which-dApps-are-supported-by-Ambire-Wallet-"
          target="_blank"
          rel="noreferrer"
        >
          this article
      ...
      <div className={styles.advancedMode}>
        ...
        <Checkbox
          label="I know what I'm doing and I accept the risks"
          checked={advancedMode}
          onChange={({ target }) => setAdvancedMode(target.checked)}
        />
      </div>
    </Modal>
  )
