  ...
  return (
    ...
    >
      ...
      <p className={styles.text}>
        You have a balance of $1,000 or more in your Ambire wallet - this means you are eligible to
        earn WALLET rewards!
        <br />
        The bigger your account balance, the more rewards you earn, and you can claim them every
        Monday.
      </p>
      <a
