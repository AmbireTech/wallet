...
import PaperImportModal from 'components/Modals/PaperImportModal/PaperImportModal'
...
export default function AddAccount({ relayerURL, onAddAccount, utmTracking, pluginData, accounts }) {
  ...
  }, [onSignerAddressClicked, showModal, signersToChoose, handleSelectSignerAccountModalCloseClicked])
