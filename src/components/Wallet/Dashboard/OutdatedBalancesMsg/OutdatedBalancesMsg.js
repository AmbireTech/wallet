        ...
        <div className={styles.alert}>
          ...
          <div className={styles.body}>
            <h4 className={styles.title}>
              Dashboard balances could appear incomplete or outdated.
            </h4>
            <p className={styles.text}>
              We are currently experiencing technical difficulties with our third party services, so
              what you see on the dashboard may be incomplete or outdated. You can check{' '}
              <a
              ...
              to see your current balances. However, you can use Ambire normally with any connected
              dApp.
            </p>
          </div>
