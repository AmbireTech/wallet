...
const Links = () => {
    ...
    return (
        <DropDown className={`${styles.wrapper} ${linksViewed ? styles.viewed : ''}`} title={<img src={`${window.location.origin}/resources/icons/question-mark.svg`} alt='help-icon' />} onOpen={onOpen}>
