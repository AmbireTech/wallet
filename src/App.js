...
function AppInner() {
  ...
  const { utm } = useUtmTracking({ accounts, useStorage: useLocalStorage })
  ...
  return (<>
    ...
    <Switch>
      <Route path="/add-account">
        <AddAccount relayerURL={relayerURL} onAddAccount={onAddAccount} accounts={accounts} utm={utm}></AddAccount>
      </Route>
